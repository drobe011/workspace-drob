...
cprequire_test(["inline:com-chilipeppr-workspace-drob"], function(ws) {
    ...
    $('title').html("drob Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-drob", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-drob", // Make the id the same as the cpdefine id
        name: "Workspace / drob", // The descriptive name of your widget.
        desc: `drob's ChiliPeppr Workspace.`,
